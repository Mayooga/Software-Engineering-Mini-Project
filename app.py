...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .suggestion-list{margin-top:10px;font-size:12px;color:var(--muted);line-height:1.5}
  .suggestion-item{margin-bottom:6px;padding-left:10px;position:relative}
  .suggestion-item::before{content:'•';position:absolute;left:0;top:0;color:var(--accent)}
...
<div class="wrap">
  ...
  <div id="liveSection">
    ...
    <div class="panel">
      <div class="ptitle">🛡 Risk Reduction Suggestions</div>
      <div id="suggestionsList" class="suggestion-list">
        <div style="color:var(--muted);font-size:12px;">Suggestions will appear here after the analysis finishes.</div>
      </div>
    </div>
  </div>
